 ...
 */
public class hapusItemPenjualan extends javax.swing.JDialog {

    /**
     * Creates new form hapusItemPenjualan
     */
    int row;
    
    public hapusItemPenjualan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public hapusItemPenjualan(java.awt.Frame parent, boolean modal, String kodeObat,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hapusItemPenjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                hapusItemPenjualan dialog = new hapusItemPenjualan(new javax.swing.JFrame(), true);
